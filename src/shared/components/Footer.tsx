...
export const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/AnnieRandrian22/",
      icon: (
    ...
    {
      name: "Email",
      url: "mailto:randrian.annie@gmail.com",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold text-gradient mb-4">Ninita</h3>
        ...
        <div className="border-t border-border pt-6">
          ...
          <p className="text-text-secondary text-sm text-center md:text-left">
              &copy; {currentYear} RANDRIANANTENAINA Malalatiana Annie Christelle.{" "}
              {t("footer.copyright")}.
            </p>
